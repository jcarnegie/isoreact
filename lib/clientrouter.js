 ...
 * @return {[type]}                   [description]
 */
var reactPageAction = r.curry(function(react, containerSelector, layout, component) {
    return reactPageActionWithState(react, null, containerSelector, layout, component);
});
 ...
 * @return {[type]}                   [description]
 */
var reactPageActionWithState = r.curry(function(react, state, containerSelector, layout, component) {
    return function(route, params) { 
        ...
        react.withContext(context, function() {
            var props      = { body: component, $context: context };
            var container  = react.createFactory(layout)(props);
            var domElement = document.querySelector(containerSelector);
            react.render(container, domElement);
        });
    }
});
 ...
 * @return {[type]}                   [description]
 */
var init = r.curry(function(routes, containerSelector, url, layout, e) {
    ...
    if (route) {
        ...
        var action  = reactPageActionWithState(state, containerSelector, layout, route.component);
        action(route, params);
    }
});
...
module.exports = function(react) {
    return {
        ...
        match: match,
        init: init,
        reactPageAction: reactPageAction(react),
