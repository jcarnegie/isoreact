 ...
 * @return {promise}
 */
var reactRouteHandler = function(htmlTemplate, layoutComponent, pageComponent, asyncStateFn) {
 ...
 */
var setClientRoute = r.curry(function(html, defaultLayout, app, route) {
    ...
    app.get(path, reactRouteHandler(html, layoutComponent, pageComponent, asyncStateFn));
    return app; 
});
